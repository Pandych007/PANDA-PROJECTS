document.addEventListener('DOMContentLoaded', function () {
    const apiUrl = 'https://cats.petiteweb.dev/api/single/sergio';
    ...
    window.showViewCatModal = function (id) {
        ...
        catInfoContainer.innerHTML = `
            <div class="cat-info">
                ...
                <div class="cat-image">
                    <img src="${cat.image || 'img/kotik3.png'}" alt="${cat.name}">
                </div>
            </div>
        `;
        ...
        fetch(`${apiUrl}/show`)
            ...
            .then(cats => {
                ...
                cats.forEach(cat => {
                    ...
                    catCard.innerHTML = `
                        <img src="${cat.image || 'img/kotik3.png'}" alt="Котик" style="width: 100%; height: auto;">
                        <h3>${cat.name}</h3>
                        <div>
                           
                            <button onclick="showEditCatModal(${cat.id})"><i class="fa-solid fa-pen" style="color:#e08300;"></i></button>
                            <button onclick="deleteCat(${cat.id})"><i class="fa-solid fa-delete-left" style="color: #e08300;"></i></button> 
